"""Конфиг — копия proxy/config.py для процессной версии."""
...
@dataclass
class LimitsConfig:
    max_client_conns: int = 1000          # лимит на воркер
    max_conns_per_upstream: int = 250     # лимит на воркер
    backlog: int = 1024
